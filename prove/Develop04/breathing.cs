public class Breathing: Activity{
    ...
    public void startBreathing(Activity breathing){
        Animation ani = new Animation();
        // This is the bulk of the breathing activity.
        Console.Clear();
        Console.WriteLine(breathing.getOpening());
        ...
        int repeat = breathing.getDuration() / 10;
        int remainder = breathing.getDuration() % 10;
        ...
        breathing.setClosing(breathing.getDuration());
        ani.createAnimation(3);
        Console.WriteLine(breathing.getClosing());
        ani.createAnimation(5);

    }
    public Breathing(string promptIn, string promptOut){
